...
public class PhoneBookView {
	...
	public static String UPDATE_Q = "Please enter the exact person name";
	public static String UPDATE_NUM_Q = "Please enter the phone number";
	public static String DELETE_Q = "Please enter the exact person name";
	public static String CANT_MODIFY_Q = "Can't find the person   Enter \"" +
	...
	public static String IDLE_Q = 
	  ...
	  PhoneBookController.UPDATE_COMMAND +
		"\" to update a person's number or \"" +
	  PhoneBookController.DELETE_COMMAND +
	  "\" to delete a person's number or \"" +
		PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	 ...
	 * @param newState
	 */
	public void stateHasChanged(PhoneBookModel model, String newState) throws Exception{
	 ...
	 * @param newState
	 */
	public void changeView(String newState) throws Exception{
		...
		else if (newState.equals(PhoneBookModel.UPDATE_STATE)) {
			System.out.println(UPDATE_Q);
		}
		else if (newState.equals(PhoneBookModel.UPDATE_NUMBER_STATE)) {
			System.out.println(UPDATE_NUM_Q);
		}
		else if(newState.equals(PhoneBookModel.CANT_MODIFY_STATE)) {
			System.out.println(CANT_MODIFY_Q);
		}
